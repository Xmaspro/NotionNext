...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Space Cat', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A lifelong learner🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://morefish.win', // 网站地址
